...
export function useQuestionForm() {
    ...
    function loadForEdit(editItem: any) {
        ...
        correctIndex.value = editItem.options.findIndex((opt: option) => opt.correct === true)
    }


    return {
        options, question, correctIndex, showValidation, lessOptions, moreOptions, noCorrectSelected, addOption, deleteOption, putTrueOnCorrectOption, clearForm, loadForEdit
    }
